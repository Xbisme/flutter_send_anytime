...
- **Next spec**: **#004 Send Flow (Gửi)** — file selection (any type, multi-select) + Send screen consuming the #003 `PairingCubit`/pairing primitives → Connect ("Mã 6 số") → live Progress → Complete, wiring the #002 transfer state machine to the Send UI.
...
| 004 | Send Flow (Gửi) | ⬜ Not started 🟡 Next | `004-send-flow` |
