...
| 010 | Settings & Preferences | ✅ Implemented (code) · 2-device smoke deferred | `010-settings` |
| 011 | Background Transfer (Live Activity / FG Service) | ⬜ **Not started** ← next | `011-background-transfer` |
