...
> Last updated: 2026-06-29 (Specs #001–#012 merged via PRs #1–#12; **#012 Home Completion merged** — Home now shows real history-backed data + See-all screens. **One v1.0 feature spec remains before Polish**: #013 In-App Viewers (Polish & Release = #014). **Next: #013 In-App Viewers**.)
