...
> Last updated: 2026-06-27 (Specs #001–#010 merged via PRs #1–#10 · #010 device-validated on 2 devices + first `pod install` OK. **Three v1.0 feature specs added before Polish**: #011 Background Transfer · #012 Home Completion · #013 In-App Viewers (Polish & Release renumbered → #014). **Next: #011 Background Transfer.** UI for all three is in the updated claude_design `SafeSend` project — `DesignSync` before building.)
...
| 011 | Background Transfer (Live Activity / FG Service) | ✅ Implemented (Dart core) · native/device deferred | `011-background-transfer` |
| 012 | Home Screen Completion (real data + See-all) | ⬜ Not started | `012-home-completion` |
