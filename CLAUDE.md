...
Active feature: **#006 Lịch sử (History)** ✅ IMPLEMENTED (branch `006-history`). #001 ✅ · #002 ✅ · #003 ✅ · #004 ✅ · #005 ✅ merged (MVP, device-validated) · #006 ✅ implemented. **Next: #007 QR Connect.**
Current plan: [specs/006-history/plan.md](specs/006-history/plan.md)
Spec: [specs/006-history/spec.md](specs/006-history/spec.md)
